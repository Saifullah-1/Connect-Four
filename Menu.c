...
int menu(void)
{
    ...
    do
    {
        ...
        {
        case 1:
            SetConsoleTextAttribute(console, 12);gotoxy(53, 13);printf("[1] Start Game");
            break;
        case 2:
            SetConsoleTextAttribute(console, 12);gotoxy(53, 14);printf("[2] Load Game");break;
        case 3:
            SetConsoleTextAttribute(console, 12);gotoxy(53, 15);printf("[3] Top Scores");break;
        case 4:
            SetConsoleTextAttribute(console, 12);gotoxy(53, 16);printf("[4] Credit");break;
        case 5:
            SetConsoleTextAttribute(console, 12);gotoxy(53, 17);printf("[5] Exit");break;
        }
        ch = getch();
        if (ch == 72)
        {
...
int gameMode(void)
{
    ...
    do
    {
        ...
        {
        case 1:
            SetConsoleTextAttribute(console, 12);gotoxy(43, 13);printf("[1] One Player Mode : VS. Computer");break;
        case 2:
            SetConsoleTextAttribute(console, 12);gotoxy(43, 14);printf("[2] Two Player Mode : VS. Human");break;
        }
        ch = getch();
        if (ch == 72)
        {
